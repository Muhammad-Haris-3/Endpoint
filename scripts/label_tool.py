...
def main():
    ...
    print('')
    print('Read GOLDSET_PROTOCOL.md 2 and 3 before starting. Rules 8-10 are new:')
    print('  8  vague -> specific: DIFFERENT if another measure would also have fitted')
    print('     the earlier wording (a choice was made); REFINED if it would not.')
    print('  9  inverse framing (mortality <-> freedom from mortality) is SAME.')
    print(' 10  pulling a component out of a stated combination is DIFFERENT.')
    print('')
